...
func (r *Repo) CreateWallet(ctx context.Context, wallet entity.Wallet, userID entity.UserID) (entity.Wallet, error) {
	query := `
...
//nolint:lll
func (r *Repo) UpdateWallet(ctx context.Context, walletID entity.WalletID, newInfoWallet entity.WalletUpdate, rate float64, userID entity.UserID) (entity.Wallet, error) {
...
func (r *Repo) DeleteWallet(ctx context.Context, walletID entity.WalletID, userID entity.UserID) error {
	currentWallet, err := r.GetWallet(ctx, walletID, userID)
	if err != nil {
...
WHERE TRUE 
	...
	_, err = r.db.Exec(ctx, query, walletID, userID)
	if err != nil {
...
func (r *Repo) GetWallets(ctx context.Context, request entity.GetWalletsRequest, userID entity.UserID) ([]entity.Wallet, error) {
	var (
	...
	query, args := r.GetWalletsQuery(request, userID)
...
func (r *Repo) GetWalletsQuery(request entity.GetWalletsRequest, userID entity.UserID) (string, []any) {
	var (
		sb              strings.Builder
		args            []any
...
func (r *Repo) ArchiveStaleWallets(ctx context.Context, checkPeriod time.Duration) error {
